      ...
      <section className="relative overflow-hidden bg-charcoal">
        <div className="mx-auto grid max-w-6xl items-center gap-10 px-5 py-16 md:grid-cols-2 md:py-24">
          ...
          <div className="relative">
            ...
            <div className="relative aspect-square w-full rounded-[2.5rem] bg-gradient-to-br from-flame/30 to-gold/20 shadow-glow" />
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-5 py-20">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {featured.map((item) => (
            <div
              key={item.id}
              className="group flex flex-col justify-between overflow-hidden rounded-3xl bg-white p-5 shadow-soft transition-transform hover:-translate-y-1 hover:shadow-glow"
            >
              <div>
